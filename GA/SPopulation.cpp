/*
 *  OOGA_CPP
 *  2001-2009 by St��phane Sanchez, Alain Berro, Herv�� Luga and Yves Duthen
 *
 *
 *  Contact:
 *  Institut de Recherche en Informatique de Toulouse (IRIT)
 *  Equipe Visual Objects : from Reality To EXpression (VORTEX)
 *  Universit� Toulouse 1 Sciences Sociales (IRIT-UT1)
 ...
 *
 * Ce constructeur intialise le g�nome de r�f�rence, la taille de la
 * Population et les param�tres d'�volution mais il ne cr�e pas
 * les individus de cette Population.
 *
 * Le <b>g�nome de r�f�rence</b> est le g�nome qui va servir � cr�er toute
 * la Population. Chaque individu aura une structure g�n�tique
 * identique au g�nome de r�f�rence.
 *
 * @param	g		Genome de r�f�rence
 * @param	taille	taille de la population
 * @param	p		ensemble des param�tres d'�volution
 *
 *****************************************************************************/
...
/*****************************************************************************
 * Initialise al�atoirement les individus de la population.
 *
 * Cette m�thode cr�e et d'initialise al�atoirement
 ...
 *
 * Cette m�thode cr�e un nouvel individu al�atoirement, l'ajoute � la
...
void SPopulation::initGeneration()
{
    ...
    this->mChangesArray = new bool[this->mMatingSize];	// Tableau d'�tats des individus
...
void SPopulation::selectionGA()
{
    ...
    double* lSumArray = new double[this->mNbGenomes];	// Tableau des sommes pour la roulette pip�e
    ...
    //----- Initialisation des modes de s�lection
    switch
            (this->mSelection)
    {
    ...
    //----- S�lection : Passage � la population this � mating pool
    i = this->mMatingSize;
...
void SPopulation::generation()
{
    ...
    /*----- Mise �� jour des param�tres de l'algorithme -----*/
    ...
    /*----- Croisement : Passage de la population p1 � p2 -----*/
    ...
    /*----- Mise � jour de la population et notation -----*/
    time(&lTime);
    ...
    /*----- Copie du meilleur dans la g�n�ration suivante -----*/
    if
            ( this->mElitism )
    {
    ...
    /*----- Calculs statistiques et dur�e de la g�n�ration -----*/
    time(&lTime);
